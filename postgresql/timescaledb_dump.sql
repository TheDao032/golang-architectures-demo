...
2	public	raw	_timescaledb_internal	_hyper_2	1	_timescaledb_functions	calculate_chunk_interval	0	0	\N	0
3	public	acq	_timescaledb_internal	_hyper_3	1	_timescaledb_functions	calculate_chunk_interval	0	0	\N	0
4	public	pod	_timescaledb_internal	_hyper_4	1	_timescaledb_functions	calculate_chunk_interval	0	0	\N	0
5	public	sta	_timescaledb_internal	_hyper_5	1	_timescaledb_functions	calculate_chunk_interval	0	0	\N	0
6	public	nav	_timescaledb_internal	_hyper_6	1	_timescaledb_functions	calculate_chunk_interval	0	0	\N	0
\.
...
2	3	_timescaledb_internal	_hyper_3_2_chunk	\N	f	0	f	2024-02-27 04:10:33.662793+00
\.
...
1	1	rx_time	timestamp with time zone	t	\N	\N	\N	604800000000	\N	\N	\N
2	2	rx_time	timestamp with time zone	t	\N	\N	\N	604800000000	\N	\N	\N
3	3	rx_time	timestamp with time zone	t	\N	\N	\N	604800000000	\N	\N	\N
4	4	rx_time	timestamp with time zone	t	\N	\N	\N	604800000000	\N	\N	\N
5	5	rx_time	timestamp with time zone	t	\N	\N	\N	604800000000	\N	\N	\N
6	6	rx_time	timestamp with time zone	t	\N	\N	\N	604800000000	\N	\N	\N
\.
...
2	3	1407974400000000	1408579200000000
\.
...
2	2	constraint_2	\N
2	\N	2_3_acq_experiment_id_fkey	acq_experiment_id_fkey
2	\N	2_4_acq_signal_id_fkey	acq_signal_id_fkey
\.
...
2	_hyper_3_2_chunk_acq_rx_time_idx	3	acq_rx_time_idx
\.
...
install_timestamp	2024-02-27 03:23:33.426197+00	t
timescaledb_version	2.14.2	f
exported_uuid	3be1b85c-2e29-4c7e-a609-0b473724bda0	t
\.
...
COPY public.acq (rx_time, experiment_id, signal_id, doppler, code_phase, acf_corr, noise_floor, acq_mode) FROM stdin;
\.
...
COPY public.application (id, application_name) FROM stdin;
\.
...
COPY public.experiment (id, mission_operation_id, experiment_type_id, start_time, end_time) FROM stdin;
1	1	1	\N	\N
\.
...
COPY public.experiment_type (id, experiment_type_name) FROM stdin;
2	Sample capture
3	Software update
...
COPY public.log (rx_time, experiment_type_id, priority, size, message) FROM stdin;
\.
...
COPY public.log_priority (id, log_priority_name) FROM stdin;
\.
...
COPY public.mission_operation (id, mission_operation_name, start_time, end_time) FROM stdin;
1	1	\N	\N
2	2	\N	\N
\.
...
COPY public.nav (rx_time, experiment_id, application_id, wn, tow, decimals, n_sat, pos_x, pos_y, pos_z, vel_x, vel_y, vel_z, pos_std, vel_std, tim_std, clock_bias, clock_drift, ggto, gdop, pdop, hdop, vdop, tdop) FROM stdin;
\.
...
COPY public.operation_modes (id, rx_operation_mode_name) FROM stdin;
1	1
2	2
3	3
\.
...
COPY public.pod (rx_time, experiment_id, application_id, wn, tow, decimals, n_sat, pos_x, pos_y, pos_z, vel_x, vel_y, vel_z, pos_std, vel_std, clock_bias, clock_drift, ambig_vec, ambig_acc) FROM stdin;
\.
...
COPY public.raw (rx_time, experiment_id, signal_id, sv_id, fd_raw, fd_rate_raw, carrier_phase, pr_raw) FROM stdin;
\.
...
COPY public.signal (id, signal_name) FROM stdin;
1	signal1
2	signal2
3	signal3
0	signal0
...
COPY public.sta (rx_time, experiment_id, rx_operation_mode_id, application_id, signal_id, number_of_channels, sv_id, channel_status, number_of_apps, ecc_error_count, cpu_temp, frontend_temp, qn400_version_number) FROM stdin;
\.
...
--
-- Name: _hyper_3_2_chunk 2_3_acq_experiment_id_fkey; Type: FK CONSTRAINT; Schema: _timescaledb_internal; Owner: postgres
--

ALTER TABLE ONLY _timescaledb_internal._hyper_3_2_chunk
    ADD CONSTRAINT "2_3_acq_experiment_id_fkey" FOREIGN KEY (experiment_id) REFERENCES public.experiment(id);
...
--
-- Name: acq acq_experiment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.acq
    ADD CONSTRAINT acq_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiment(id);


--
-- Name: acq acq_signal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.acq
    ADD CONSTRAINT acq_signal_id_fkey FOREIGN KEY (signal_id) REFERENCES public.signal(id);
...
--
-- Name: log log_experiment_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.log
    ADD CONSTRAINT log_experiment_type_id_fkey FOREIGN KEY (experiment_type_id) REFERENCES public.experiment_type(id);


--
-- Name: log log_priority_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.log
    ADD CONSTRAINT log_priority_fkey FOREIGN KEY (priority) REFERENCES public.log_priority(id);


--
-- Name: nav nav_application_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.nav
    ADD CONSTRAINT nav_application_id_fkey FOREIGN KEY (application_id) REFERENCES public.application(id);


--
-- Name: nav nav_experiment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.nav
    ADD CONSTRAINT nav_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiment(id);


--
-- Name: pod pod_application_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pod
    ADD CONSTRAINT pod_application_id_fkey FOREIGN KEY (application_id) REFERENCES public.application(id);


--
-- Name: pod pod_experiment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pod
    ADD CONSTRAINT pod_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiment(id);


--
-- Name: raw raw_experiment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.raw
    ADD CONSTRAINT raw_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiment(id);


--
-- Name: raw raw_signal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.raw
    ADD CONSTRAINT raw_signal_id_fkey FOREIGN KEY (signal_id) REFERENCES public.signal(id);


--
-- Name: sta sta_application_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sta
    ADD CONSTRAINT sta_application_id_fkey FOREIGN KEY (application_id) REFERENCES public.application(id);


--
-- Name: sta sta_experiment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sta
    ADD CONSTRAINT sta_experiment_id_fkey FOREIGN KEY (experiment_id) REFERENCES public.experiment(id);


--
-- Name: sta sta_rx_operation_mode_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sta
    ADD CONSTRAINT sta_rx_operation_mode_id_fkey FOREIGN KEY (rx_operation_mode_id) REFERENCES public.operation_modes(id);


--
-- Name: sta sta_signal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sta
    ADD CONSTRAINT sta_signal_id_fkey FOREIGN KEY (signal_id) REFERENCES public.signal(id);
